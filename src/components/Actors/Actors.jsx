...
// use newly created useGetActor to get actor's info to the component
...
const Actors = () => {
  ...
  if (error) {
    return (
      <Box display="flex" justifyContent="center" aignItems="center">
      ...
      <Grid container spacing={3}>
        ...
        <Grid item lg={7} xl={8} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
          ...
          <Typography variant="body2" align="justify" paragraph>
            {data?.biography || 'There is no biography yet.'}
          </Typography>
